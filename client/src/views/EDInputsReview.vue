                        ...
                        <div class="overflow-x">
                            <table class="full-table">
                                ...
                                <tr v-for="(worker) in this.workerData">
                                    ...
                                    <td v-for="operation in this.operationNames"><input :value="worker.skills.find(e => this.operationToLocationData.find(f => f.asset.operation_to_locations[0].operation_id == e.operation_id).asset.operation_to_locations[0].operation.display_name == operation)" type="checkbox"/></td>
                                </tr>
                            </table>
                        </div>
