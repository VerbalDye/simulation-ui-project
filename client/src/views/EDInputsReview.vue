    ...
    methods: {
        ...
        selectedOperationChange() {
            ...
            if (selectedExperimentAssets.length > 0) {
                ...
                console.log(this.processTimeData.filter(e => e.process_time.model_number == this.processTimeSettings.selectedModels[this.assetData[0].asset_id][0]));
                console.log(this.processTimeData.filter(e => e.process_time.model_number == this.processTimeSettings.selectedModels[this.assetData[0].asset_id][1]));
